...
// src/app/stalker/stalker.routes.ts
var stalkerRoutes = [
  {
    path: "stalker/:id",
...
// src/app/xtream-tauri/xtream.routes.ts
var xtreamRoutes = [
  {
    path: "xtreams/:id",
...
function relaunch() {
  return __async(this, null, function* () {
    yield invoke("plugin:process|restart");
  });
}

// node_modules/@tauri-apps/plugin-updater/dist-js/index.js
var Update = class _Update extends Resource {
  ...
  download(onEvent, options) {
    return __async(this, null, function* () {
      ...
      const downloadedBytesRid = yield invoke("plugin:updater|download", __spreadValues({
        onEvent: channel,
        rid: this.rid
      }, options));
  ...
  install() {
    return __async(this, null, function* () {
      ...
      yield invoke("plugin:updater|install", {
        updateRid: this.rid,
  ...
  downloadAndInstall(onEvent, options) {
    return __async(this, null, function* () {
      ...
      yield invoke("plugin:updater|download_and_install", __spreadValues({
        onEvent: channel,
        rid: this.rid
      }, options));
    });
  ...
  close() {
    return __async(this, null, function* () {
      yield this.downloadedBytes?.close();
      yield __superGet(_Update.prototype, this, "close").call(this);
    });
  }
};
function check(options) {
  return __async(this, null, function* () {
    ...
    return yield invoke("plugin:updater|check", __spreadValues({}, options)).then((meta) => meta.available ? new Update(meta) : null);
  });
}
...
function AppComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(0, "\n  ");
    \u0275\u0275elementStart(1, "ngx-whats-new", 0);
    \u0275\u0275listener("closeModal", function AppComponent_Conditional_3_Template_ngx_whats_new_closeModal_1_listener() {
      \u0275\u0275restoreView(_r1);
...
var AppComponent = class _AppComponent {
  constructor(dataService, dialog, epgService, playlistService, router, store, snackBar, translate, settingsService, whatsNewService) {
    ...
    this.listeners = [];
    if ((this.dataService.isElectron && this.dataService?.remote?.process.platform === "linux" || this.dataService?.remote?.process.platform === "win32") && this.dataService.remote.process.argv.length > 2) {
      const filePath = this.dataService.remote.process.argv.find((filepath) => filepath.endsWith(".m3u") || filepath.endsWith(".m3u8"));
      if (filePath) {
  ...
  checkForUpdates() {
    return __async(this, null, function* () {
      if (isTauri()) {
        const update = yield check();
        if (update?.available) {
          console.log(`found update ${update.version} from ${update.date} with notes ${update.body}`);
          let downloaded = 0;
          let contentLength = 0;
          const wantsUpdate = yield ask(`New version ${update.version} is available. Do you want to update now?`);
          if (wantsUpdate) {
            yield update.downloadAndInstall((event) => {
              switch (event.event) {
                case "Started":
    ...
    return __async(this, null, function* () {
      if (isTauri()) {
        ...
        if (playlistForAutoUpdate && playlistForAutoUpdate.length > 0)
          this.dataService.sendIpcEvent(AUTO_UPDATE_PLAYLISTS, playlistForAutoUpdate);
      }
    });
  }
  /**
  ...
  initSettings() {
    this.settingsService.getValueFromLocalStorage(STORE_KEY.Settings).subscribe((settings) => {
      if (settings && Object.keys(settings).length > 0) {
        ...
        if (settings.epgUrl?.length > 0 && settings.epgUrl?.some((u) => u !== "") && isTauri()) {
   ...
   */
  showWhatsNewDialog() {
    this.modals = this.whatsNewService.getModalsByVersion(this.dataService.getAppVersion());
    this.setDialogVisibility(true);
  }
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(EpgService), \u0275\u0275directiveInject(PlaylistsService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(Store), \u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(SettingsService), \u0275\u0275directiveInject(WhatsNewService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: false, decls: 5, vars: 3, consts: [[3, "closeModal", "items", "options"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "router-outlet");
        \u0275\u0275text(1, "\n");
        \u0275\u0275text(2, "\n");
        \u0275\u0275conditionalCreate(3, AppComponent_Conditional_3_Template, 3, 2);
        \u0275\u0275pipe(4, "async");
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275conditional(\u0275\u0275pipeBind1(4, 1, ctx.isDialogVisible$) ? 3 : -1);
      }
    }, dependencies: [RouterOutlet, NgxWhatsNewComponent, AsyncPipe], encapsulation: 2 });
  }
};
(() => {
  ...
  }], () => [{ type: DataService }, { type: MatDialog }, { type: EpgService }, { type: PlaylistsService }, { type: Router }, { type: Store }, { type: MatSnackBar }, { type: TranslateService }, { type: SettingsService }, { type: WhatsNewService }], null);
})();
(() => {
...
var PwaService = class _PwaService extends DataService {
  ...
  sendIpcEvent(type, payload) {
    if (type === PLAYLIST_PARSE_BY_URL) {
      ...
      return this.forwardXtreamRequest(payload);
    } else if (type === STALKER_REQUEST) {
      return this.forwardStalkerRequest(payload);
    } else {
  ...
  forwardXtreamRequest(payload) {
    return __async(this, null, function* () {
      ...
      try {
        let result;
        const response = yield firstValueFrom(this.http.get(`${this.corsProxyUrl}/xtream`, __spreadValues({
  ...
  forwardStalkerRequest(payload) {
    return __async(this, null, function* () {
      try {
        const params = new URLSearchParams(__spreadProps(__spreadValues({
          url: payload.url
        }, payload.params), {
          macAddress: payload.macAddress
        }));
        const response = yield fetch(`${this.corsProxyUrl}/stalker?${params.toString()}`);
        if (!response.ok) {
          throw new Error(`Error: ${response.statusText} (Status: ${response.status})`);
        }
        return (yield response.json()).payload;
      } catch (err) {
  ...
  static {
    this.\u0275fac = function PwaService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PwaService)();
    };
  }
  static {
...
function fetch2(input, init) {
  return __async(this, null, function* () {
    ...
    const buffer = yield req.arrayBuffer();
    ...
    const rid = yield invoke("plugin:http|fetch", {
      clientConfig: {
        method: req.method,
        url: req.url,
    ...
    const { status, statusText, url, headers: responseHeaders, rid: responseRid } = yield invoke("plugin:http|fetch_send", {
      rid
    });
    const body = yield invoke("plugin:http|fetch_read_body", {
      rid: responseRid
    });
...
var import_iptv_playlist_parser = __toESM(require_src());
var TauriService = class _TauriService extends DataService {
  constructor() {
    super();
    this.eventListeners = {};
    this.snackBar = inject(MatSnackBar);
  ...
  setupEventListeners() {
    return __async(this, null, function* () {
      this.eventListeners["player-error"] = yield listen("player-error", (event) => {
        console.error("Player error:", event);
        this.snackBar.open(`Player Error: ${event.payload}`, "Close", { duration: 5e3 });
      });
    });
  }
  getAppVersion() {
  ...
  sendIpcEvent(type, payload) {
    return __async(this, null, function* () {
      if (type === PLAYLIST_PARSE_BY_URL) {
        ...
        const data = payload;
        const playlist = yield readTextFile(data.filePath);
        const parsedPlaylist = (0, import_iptv_playlist_parser.parse)(playlist);
        const playlistObject = createPlaylistObject(data.title, parsedPlaylist, data.filePath, "FILE");
        window.postMessage({
          type: PLAYLIST_UPDATE_RESPONSE,
          payload: {
            message: "Success! The playlist was successfully updated",
            playlist: __spreadProps(__spreadValues({}, playlistObject), {
              _id: data.id
            })
          }
        });
      } else if (type === "XTREAM_REQUEST") {
        return yield this.forwardXtreamRequest(payload);
      } else if (type === "STALKER_REQUEST") {
        return this.fetchStalkerData(payload);
        ...
        try {
          return yield invoke("open_in_mpv", {
            ...
            userAgent: data["user-agent"] ?? void 0,
            referer: data.referer ?? void 0,
            origin: data.origin ?? void 0
          });
        } catch (error2) {
          this.snackBar.open(`Error launching MPV: ${error2}`, "Close", {
            duration: 5e3
          });
          console.error("MPV launch error:", error2);
          throw error2;
        }
      } else if (type === "OPEN_VLC_PLAYER") {
        const data = payload;
        try {
          return yield invoke("open_in_vlc", {
            url: data.url,
          ...
          this.snackBar.open(`Error launching VLC: ${error2}`, "Close", {
            duration: 5e3
          });
          console.error("VLC launch error:", error2);
          throw error2;
        }
        ...
        const data = payload;
        try {
          for (var iter = __forAwait(data), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
            const item = temp.value;
            if (item.filePath) {
              const playlist = yield readTextFile(item.filePath);
              const parsedPlaylist = (0, import_iptv_playlist_parser.parse)(playlist);
              const playlistObject = createPlaylistObject(item.title, parsedPlaylist, item.filePath, "FILE");
              playlists.push(__spreadProps(__spreadValues({}, playlistObject), { _id: item._id }));
            }
          }
        } catch (temp) {
          error = [temp];
  ...
  fetchStalkerData(payload) {
    return __async(this, null, function* () {
      try {
        ...
        const response = yield fetch2(url.toString(), {
          method: "GET",
          headers: {
            Cookie: `mac=${payload.macAddress}`
          }
  ...
  fetchFromUrl(payload) {
    return __async(this, null, function* () {
      try {
        const response = yield fetch2(payload.url);
        const responseBody = yield response.text();
        const parsedPlaylist = (0, import_iptv_playlist_parser.parse)(responseBody);
        const extractedName = payload.url && payload.url.length > 1 ? getFilenameFromUrl(payload.url) : "";
        const playlistName = !extractedName || extractedName === "Untitled playlist" ? "Imported from URL" : extractedName;
        const playlist = createPlaylistObject(playlistName, parsedPlaylist, payload.url, "URL");
        window.postMessage({
          type: PLAYLIST_PARSE_RESPONSE,
          payload: __spreadProps(__spreadValues({}, playlist), { isTemporary: payload.isTemporary })
        });
      } catch (error) {
        window.postMessage({
          type: ERROR,
  ...
  fetchData(url, queryParams) {
    return __async(this, null, function* () {
      ...
      const response = yield fetch2(urlObject.toString());
      if (!response.ok) {
        throw new Error(`Error: ${response.statusText} (Status: ${response.status})`);
      }
  ...
  static {
    this.\u0275fac = function TauriService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _TauriService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TauriService, factory: _TauriService.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TauriService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var PlaylistEffects = class _PlaylistEffects {
  constructor(actions$, playlistsService, dataService, router, snackBar, storage, store, translate) {
    ...
    this.updateFavorites$ = createEffect(() => {
      return this.actions$.pipe(ofType(updateFavorites), combineLatestWith(this.store.select(selectFavorites), this.store.select(selectActivePlaylistId)), switchMap(([, favorites, playlistId]) => this.playlistsService.updateFavorites(playlistId, favorites)), tap(() => {
        this.snackBar.open(this.translate.instant("CHANNELS.FAVORITES_UPDATED"), null, { duration: 2e3 });
      }));
    }, { dispatch: false });
    ...
    this.setActiveChannel$ = createEffect(() => {
      return this.actions$.pipe(ofType(setActiveChannel), map((action) => {
    ...
    this.addPlaylist$ = createEffect(() => {
      return this.actions$.pipe(ofType(addPlaylist), switchMap((action) => this.playlistsService.addPlaylist(action.playlist)), map((playlist) => {
        ...
        return playlist;
      }), map((playlist) => __async(this, null, function* () {
        if (playlist.serverUrl && isTauri()) {
          const db = yield Database.load("sqlite:database.db");
          const result = yield db.execute(`INSERT INTO playlists (id, name, serverUrl, username, password, type)
                        VALUES (?, ?, ?, ?, ?, ?)`, [
    ...
    this.updatePlaylistMeta$ = createEffect(() => {
      return this.actions$.pipe(ofType(updatePlaylistMeta), switchMap((action) => {
        return this.playlistsService.updatePlaylistMeta(action.playlist);
      }));
    }, { dispatch: false });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PlaylistEffects, [{
    type: Injectable,
    args: [{ providedIn: "any" }]
  }], () => [{ type: Actions }, { type: PlaylistsService }, { type: DataService }, { type: Router }, { type: MatSnackBar }, { type: StorageMap }, { type: Store }, { type: TranslateService }], null);
})();
