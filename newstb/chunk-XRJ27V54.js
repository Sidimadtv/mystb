...
var SortService = class _SortService {
  ...
  getSavedSortOptions() {
    ...
    try {
      ...
      if ((parsedOptions.by === SortBy.DATE_ADDED || parsedOptions.by === SortBy.NAME) && (parsedOptions.order === SortOrder.ASC || parsedOptions.order === SortOrder.DESC)) {
        return parsedOptions;
      }
      return defaultOptions;
    } catch (error) {
      console.error("Error retrieving sort options from localStorage:", error);
      return defaultOptions;
    }
  }
  saveSortOptions(options) {
    try {
      localStorage.setItem(SORT_OPTIONS_STORAGE_KEY, JSON.stringify(options));
    } catch (error) {
      console.error("Error saving sort options to localStorage:", error);
    }
  }
  sortPlaylists(playlists, options) {
  ...
  static {
    this.\u0275fac = function SortService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SortService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SortService, factory: _SortService.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SortService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var _c0 = ["searchQuery"];
var RecentPlaylistsComponent_Conditional_0_Defer_13_DepsFn = () => [MatIcon, MatNavList, MatListItem, MatListItemIcon, MatListItemLine, MatListItemTitle, import("./chunk-NGHCJQ63.js").then((m) => m.PlaylistItemComponent), import("./chunk-KVGJH56Y.js").then((m) => m.AsyncPipe), TranslatePipe];
var _c1 = () => ({ width: "30%", height: "20px" });
var _c2 = () => ({ width: "50%", height: "10px" });
var _forTrack0 = ($index, $item) => $item._id;
function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "\n                    ");
  ...
  if (rf & 2) {
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1("\n                            ", \u0275\u0275pipeBind1(8, 2, "HOME.PLAYLISTS.NO_PLAYLISTS"), "\n                        ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("\n                            ", \u0275\u0275pipeBind1(12, 4, "HOME.PLAYLISTS.ADD_FIRST"), "\n                        ");
  }
}
function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_For_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275text(0, "\n                        ");
    \u0275\u0275elementStart(1, "app-playlist-item", 10);
    \u0275\u0275listener("editPlaylistClicked", function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_For_16_Template_app_playlist_item_editPlaylistClicked_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.openInfoDialog($event));
    })("playlistClicked", function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_For_16_Template_app_playlist_item_playlistClicked_1_listener() {
      const item_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.getPlaylist(item_r6));
    })("refreshClicked", function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_For_16_Template_app_playlist_item_refreshClicked_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.refreshPlaylist($event));
    })("removeClicked", function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_For_16_Template_app_playlist_item_removeClicked_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(5);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(5);
    \u0275\u0275advance();
    \u0275\u0275property("item", item_r6)("showActions", !ctx_r2.sidebarMode);
  }
}
function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275text(0, "\n                    ");
    \u0275\u0275elementStart(1, "mat-list-item", 8);
    \u0275\u0275listener("click", function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_Template_mat_list_item_click_1_listener() {
      \u0275\u0275restoreView(_r4);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(14, "\n                    ");
    \u0275\u0275repeaterCreate(15, RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_For_16_Template, 3, 2, null, null, _forTrack0);
  }
  if (rf & 2) {
    const playlists_r7 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1("\n                            ", \u0275\u0275pipeBind1(8, 2, "HOME.PLAYLISTS.GLOBAL_FAVORITES"), "\n                        ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("\n                            ", \u0275\u0275pipeBind1(12, 4, "HOME.PLAYLISTS.GLOBAL_FAVORITES_DESCRIPTION"), "\n                        ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater(playlists_r7);
  }
}
function RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "\n            ");
    \u0275\u0275elementStart(1, "mat-nav-list", 4);
    \u0275\u0275text(2, "\n                ");
    \u0275\u0275conditionalCreate(3, RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_3_Template, 15, 6)(4, RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Conditional_4_Template, 17, 6);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, "\n        ");
  }
  if (rf & 2) {
...
function RecentPlaylistsComponent_Conditional_0_Defer_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "\n        ");
    \u0275\u0275conditionalCreate(1, RecentPlaylistsComponent_Conditional_0_Defer_11_Conditional_1_Template, 6, 1);
    \u0275\u0275pipe(2, "async");
  }
  if (rf & 2) {
    let tmp_3_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_3_0 = \u0275\u0275pipeBind1(2, 1, ctx_r2.playlists$)) ? 1 : -1, tmp_3_0);
  }
}
function RecentPlaylistsComponent_Conditional_0_DeferPlaceholder_12_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "\n                ");
    \u0275\u0275elementStart(1, "div", 12);
    \u0275\u0275text(2, "\n                    ");
    \u0275\u0275element(3, "ngx-skeleton-loader", 13);
    \u0275\u0275text(4, "\n                    ");
    \u0275\u0275elementStart(5, "div", 14);
    \u0275\u0275text(6, "\n                        ");
    \u0275\u0275element(7, "ngx-skeleton-loader", 15);
    \u0275\u0275text(8, "\n                        ");
    \u0275\u0275element(9, "ngx-skeleton-loader", 15);
    \u0275\u0275text(10, "\n                    ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(11, "\n                    ");
    \u0275\u0275elementStart(12, "div", 16);
    \u0275\u0275text(13, "\n                        ");
    \u0275\u0275element(14, "ngx-skeleton-loader", 17);
    \u0275\u0275text(15, "\n                    ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(16, "\n                ");
    \u0275\u0275elementEnd();
...
function RecentPlaylistsComponent_Conditional_0_DeferPlaceholder_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "\n        ");
    \u0275\u0275elementStart(1, "div", 11);
    \u0275\u0275text(2, "\n            ");
    \u0275\u0275repeaterCreate(3, RecentPlaylistsComponent_Conditional_0_DeferPlaceholder_12_For_4_Template, 18, 4, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, "\n    ");
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.ghostElements);
  }
}
function RecentPlaylistsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(10, "\n    ");
    \u0275\u0275domTemplate(11, RecentPlaylistsComponent_Conditional_0_Defer_11_Template, 3, 3)(12, RecentPlaylistsComponent_Conditional_0_DeferPlaceholder_12_Template, 6, 0);
    \u0275\u0275defer(13, 11, RecentPlaylistsComponent_Conditional_0_Defer_13_DepsFn, null, 12);
    \u0275\u0275deferOnIdle();
  }
  if (rf & 2) {
    \u0275\u0275advance(6);
...
var RecentPlaylistsComponent = class _RecentPlaylistsComponent {
  constructor(databaseService, dialog, dialogService, dataService, router, snackBar, sortService, store, translate) {
    ...
    this.ghostElements = new Array(10);
    this.playlists$ = combineLatest([
    ...
    ]).pipe(map(([playlists, searchQuery, filters, sortOptions]) => {
      ...
      return this.sortService.sortPlaylists(filteredPlaylists, sortOptions);
    }));
  ...
  removePlaylist(playlistId) {
    return __async(this, null, function* () {
      const deleted = yield this.databaseService.deletePlaylist(playlistId);
      if (deleted) {
        this.store.dispatch(removePlaylist({ playlistId }));
        this.snackBar.open(this.translate.instant("HOME.PLAYLISTS.REMOVE_DIALOG.SUCCESS"), null, {
          duration: 2e3
        });
      }
    });
  ...
  refreshPlaylist(item) {
    this.dataService.sendIpcEvent(PLAYLIST_UPDATE, __spreadValues({
      id: item._id,
      title: item.title
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RecentPlaylistsComponent, selectors: [["app-recent-playlists"]], viewQuery: function RecentPlaylistsComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        }, \u0275\u0275resolveWindow)("keydown.meta.f", function RecentPlaylistsComponent_keydown_meta_f_HostBindingHandler($event) {
          return ctx.onSearchHotkey($event);
        }, \u0275\u0275resolveWindow);
      }
    }, inputs: { sidebarMode: "sidebarMode" }, outputs: { playlistClicked: "playlistClicked" }, decls: 1, vars: 1, consts: [["searchQuery", ""], ["subscriptSizing", "dynamic", 1, "search-field"], ["matPrefix", ""], ["matInput", "", "type", "search", "spellcheck", "false", "autocomplete", "off", 3, "input", "placeholder"], [1, "playlists-list"], ["matListItemIcon", ""], ["matListItemTitle", ""], ["matListItemLine", "", 1, "meta"], [3, "click"], ["matListItemIcon", "", 1, "favorites-icon"], [3, "editPlaylistClicked", "playlistClicked", "refreshClicked", "removeClicked", "item", "showActions"], ["id", "skeleton-container"], [1, "skeleton-item"], ["count", "1", "appearance", "circle"], [1, "text"], ["count", "1", 3, "theme"], [1, "actions"], ["count", "2", "appearance", "circle"]], template: function RecentPlaylistsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, RecentPlaylistsComponent_Conditional_0_Template, 15, 3);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(RecentPlaylistsComponent, () => [import("./chunk-NGHCJQ63.js").then((m) => m.PlaylistItemComponent), import("./chunk-KVGJH56Y.js").then((m) => m.AsyncPipe)], (PlaylistItemComponent, AsyncPipe) => {
    setClassMetadata(RecentPlaylistsComponent, [{
      type: Component,
      args: [{ selector: "app-recent-playlists", imports: [
        AsyncPipe,
        MatButtonModule,
        MatDividerModule,
        MatIconModule,
        ...
        TranslatePipe
      ], template: `@if (allPlaylistsLoaded()) {
...
`, styles: ["/* src/app/home/recent-playlists/recent-playlists.component.scss */\n:host {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.mat-list-base {\n  padding-top: 0;\n}\n.playlists-list {\n  padding: 0;\n  width: 100%;\n}\n.search-field {\n  width: 96%;\n  margin: 10px 0;\n}\n.meta {\n  font-size: 12px !important;\n  color: #666;\n  margin-top: 2px !important;\n}\n::ng-deep div[matformfieldlineripple] {\n  display: none;\n}\n::ng-deep .search-field > .mat-mdc-text-field-wrapper {\n  border-radius: 30px;\n}\n#skeleton-container {\n  padding-top: 10px;\n  width: 100%;\n}\n#skeleton-container .skeleton-item {\n  display: flex;\n  padding: 0 20px;\n  height: 72px;\n}\n#skeleton-container .skeleton-item .text {\n  flex: 1;\n  align-self: center;\n  padding-left: 6px;\n  flex-direction: column;\n  display: flex;\n}\n@media only screen and (max-width: 480px) {\n  .favorites-icon {\n    padding-left: 0 !important;\n    display: none;\n  }\n  .search-field {\n    --mat-form-field-container-height: 48px;\n    --mat-form-field-filled-label-display: none;\n    --mat-form-field-container-vertical-padding: 12px;\n    --mat-form-field-filled-with-label-container-padding-top: 12px;\n    --mat-form-field-filled-with-label-container-padding-bottom: 12px;\n  }\n}\n"] }]
    }], () => [{ type: DatabaseService }, { type: MatDialog }, { type: DialogService }, { type: DataService }, { type: Router }, { type: MatSnackBar }, { type: SortService }, { type: Store }, { type: TranslateService }], { searchQueryInput: [{
      type: ViewChild,
      args: ["searchQuery"]
    }], sidebarMode: [{
      type: Input
      ...
      type: HostListener,
      args: ["window:keydown.control.f", ["$event"]]
    }, {
      type: HostListener,
      args: ["window:keydown.meta.f", ["$event"]]
    }] });
  });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RecentPlaylistsComponent, { className: "RecentPlaylistsComponent", filePath: "src/app/home/recent-playlists/recent-playlists.component.ts", lineNumber: 64 });
})();
