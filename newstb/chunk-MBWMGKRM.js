...
var PlaylistErrorViewComponent = class _PlaylistErrorViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaylistErrorViewComponent, selectors: [["app-playlist-error-view"]], inputs: { description: "description", showActionButtons: "showActionButtons", title: "title", viewType: "viewType" }, decls: 13, vars: 4, consts: [[1, "expired-account"], ["src", "./assets/images/broken-tv.svg"], ["src", "./assets/images/empty-category.svg", 1, "empty-category-img"], [1, "icon"], ["mat-stroked-button", "", "routerLink", "/"], ["mat-stroked-button", "", 3, "click"], ["mat-stroked-button", "", "color", "warn", 3, "click"]], template: function PlaylistErrorViewComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275text(1, "\n    ");
        \u0275\u0275conditionalCreate(2, PlaylistErrorViewComponent_Conditional_2_Template, 3, 0)(3, PlaylistErrorViewComponent_Conditional_3_Template, 3, 0)(4, PlaylistErrorViewComponent_Conditional_4_Template, 4, 0);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(10, "\n\n    ");
        \u0275\u0275conditionalCreate(11, PlaylistErrorViewComponent_Conditional_11_Template, 25, 9);
        \u0275\u0275elementEnd();
        \u0275\u0275text(12, "\n");
      }
      if (rf & 2) {
...
`, styles: ["/* src/app/xtream-tauri/playlist-error-view/playlist-error-view.component.scss */\n.expired-account {\n  display: flex;\n  flex-direction: column;\n  padding: 10px;\n  align-items: center;\n  gap: 10px;\n  text-align: center;\n}\n.expired-account img {\n  filter: invert(80%);\n}\n.icon {\n  font-size: 64px;\n  height: 64px;\n  width: 64px;\n}\n.empty-category-img {\n  max-width: 300px;\n}\n::ng-deep .dark-theme .expired-account img {\n  filter: invert(10%) !important;\n}\n"] }]
  }], null, { description: [{
    type: Input
  }], showActionButtons: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaylistErrorViewComponent, { className: "PlaylistErrorViewComponent", filePath: "src/app/xtream-tauri/playlist-error-view/playlist-error-view.component.ts", lineNumber: 20 });
})();
